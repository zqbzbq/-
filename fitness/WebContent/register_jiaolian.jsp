...
<title>欢迎注册斯跑特瑜伽健身社交网站教练</title>
<script src="<%=basePath%>static/register/jquery/jquery-2.1.4.min.js"></script>
<link rel="stylesheet" type="text/css" href="<%=basePath%>static/login/css/demo_jiaolian.css" />
			...
			<div class="container"
				...
				<section>
					<div id="container_demo">
						<div id="wrapper">
							<form action="<%=basePath%>fitnessUser/trains_reg.do" method="post" autocomplete="on">
								<h1>注册教练</h1>

								<p>
									<label for="usernamesignup" class="uname" data-icon="u">您的账号</label>
									<input id="username" name="userid"
										required="required" type="text" placeholder="请输入用户名" /><%-- <span id="user_checkHas" style="color:red;font-family:STkaiti;">${registMsg}</span> --%>
