		...
		<div class="admin-sidebar am-offcanvas" id="admin-offcanvas">
			<div class="am-offcanvas-bar admin-offcanvas-bar">
				<ul class="am-list admin-sidebar-list">
					...
					<li><a
						href="<%=basePath%>fitnessUser/selectnotfriends.do?currentPage=1&rows=5"><span
							class="am-icon-globe"></span>添加好友</a></li>
					<li><a href="<%=basePath%>fitnessUser/logout.do"><span
		...
		<div class="admin-content">
			<div class="am-cf am-padding">
				<div class="am-fl am-cf">
					<strong class="am-text-primary am-text-lg">添加好友</strong> / <small>about</small>
				</div>
			</div>
			<div class="am-tabs am-margin" data-am-tabs>
				<ul class="am-tabs-nav am-nav am-nav-tabs">
					<li class="am-active"><a href="#tab1">添加好友</a></li>
				</ul>
				...
				<div id="spulist-pager">
					...
					<div class="pager1">
						...
						<c:if test="${page.currentPage eq 1}">
							<a
								href="<%=basePath%>fitnessUser/selectnotfriends.do?currentPage=1&rows=5">下一页</a>
							<a
						...
						<c:if test="${page.currentPage>1 and page.currentPage<page.totalPage}">
							<a
								href="<%=basePath%>space/getallspace.do?currentPage=1&rows1=5 ">首页</a>
							<a
